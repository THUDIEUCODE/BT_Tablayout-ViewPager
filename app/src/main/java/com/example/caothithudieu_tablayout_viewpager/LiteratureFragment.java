...
public class LiteratureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView_106.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));

        bookList_106 = new ArrayList<>();
        bookList_106.add(new BookModel("Truyện Kiều", "85,000đ", "book_kieu"));
        bookList_106.add(new BookModel("Số Đỏ", "70,000đ", "book_sodo"));
